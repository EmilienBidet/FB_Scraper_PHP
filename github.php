...
<input type="email" class="form-control" id="git_email" name="git_email" placeholder="Enter email" value="lambodos0228@gmail.com">
</div>
<div class="form-group">
...
<input type="password" class="form-control" id="git_pwd" name="git_pwd" placeholder="Password" value="strawberry@228">
</div>
